export const translations = {
  ru: {
    ...
    // Дефолтный шаблон
    defaultTemplate: 'Дефолтный шаблон',
    defaultTemplateTag: 'Дефолтный',
    inviteToCampaign: 'Пригласить в кампанию',
    defaultTemplateTooltip: 'Данный шаблон используется для автоматической отправки сообщений с предложением присоединиться к активным кампаниям',
    noDefaultTemplate: 'Дефолтный шаблон не создан',
    createDefaultTemplate: 'Создать дефолтный шаблон',
    createDefaultTemplateTitle: 'Создать дефолтный шаблон',
    editDefaultTemplateTitle: 'Редактировать дефолтный шаблон',
    deleteDefaultTemplateConfirm: 'Удалить шаблон?',
    deleteDefaultTemplateDescription: 'Вы уверены, что хотите удалить шаблон? Этот шаблон используется для автоматической отправки сообщений с предложением присоединиться к активным кампаниям',
    ...
    selectStoresFirst: 'Сначала выберите магазины',
    ...
    templateNameAndTextRequired: 'Укажите название и текст шаблона',
    templateCreatedSuccessfully: 'Шаблон создан',
    templateUpdatedSuccessfully: 'Шаблон обновлён',
    templateDeletedSuccessfully: 'Шаблон удалён',
  ...
  uk: {
    ...
    // Дефолтний шаблон
    defaultTemplate: 'Дефолтний шаблон',
    defaultTemplateTag: 'Дефолтний',
    inviteToCampaign: 'Запросити в кампанію',
    defaultTemplateTooltip: 'Даний шаблон використовується для автоматичної відправки повідомлень з пропозицією приєднатися до активних кампаній',
    noDefaultTemplate: 'Дефолтний шаблон не створено',
    createDefaultTemplate: 'Створити дефолтний шаблон',
    createDefaultTemplateTitle: 'Створити дефолтний шаблон',
    editDefaultTemplateTitle: 'Редагувати дефолтний шаблон',
    deleteDefaultTemplateConfirm: 'Видалити шаблон?',
    deleteDefaultTemplateDescription: 'Ви впевнені, що хочете видалити шаблон? Цей шаблон використовується для автоматичної відправки повідомлень з пропозицією приєднатися до активних кампаній',
    ...
    selectStoresFirst: 'Спочатку оберіть магазини',
    ...
    templateNameAndTextRequired: 'Вкажіть назву та текст шаблона',
    templateCreatedSuccessfully: 'Шаблон створено',
    templateUpdatedSuccessfully: 'Шаблон оновлено',
    templateDeletedSuccessfully: 'Шаблон видалено',
    confirmDeleteTemplate: 'Ви впевнені, що хочете видалити цей шаблон?',
    save: 'Зберегти',
  ...
  en: {
    ...
    defaultTemplateTag: 'Default',
    inviteToCampaign: 'Invite to campaign',
    defaultTemplateTooltip: 'This template is used for automatic sending of messages with an invitation to join active campaigns',
    noDefaultTemplate: 'Default template not created',
    createDefaultTemplate: 'Create default template',
    createDefaultTemplateTitle: 'Create default template',
    editDefaultTemplateTitle: 'Edit default template',
    deleteDefaultTemplateConfirm: 'Delete template?',
    deleteDefaultTemplateDescription: 'Are you sure you want to delete the template? This template is used for automatic sending of messages with an invitation to join active campaigns',
    ...
    selectStoresFirst: 'Select stores first',
    ...
    templateNameAndTextRequired: 'Enter template name and text',
